...
<section class=\"image-container\">
  <img src=\"olympicswimming.png" style=\"width:100%;height:300px;object-fit:cover;\"/>
  <h1 class=\"text-center\">Olympic Swimming History 1912-2020</h1>
</section>
...
```{r, results='asis', echo=FALSE}
cat('
  <h3 class=\"text-center\">Which Countries Have Been Most Dominant?</h3>
</section>
  <h4 class=\"text-center fw-bold my-4\">Lets take a brief overview of countries which have been most successful in Olympic Swimming</h4>
  ')
```

```{r,echo=FALSE}
knitr::asis_output('<iframe height="500" width="150%" frameborder="no" src="https://janthina.shinyapps.io/InteractiveMap/"> </iframe>')
```
<br>
...
```{r,echo=FALSE}
knitr::asis_output('<iframe height="500" width="150%" frameborder="no" src="https://janthina.shinyapps.io/InteractiveBarChart/"> </iframe>')
```
...
```{r, results='asis', echo=FALSE}
cat('
  <h3 class=\"text-center\">Swimming Results Over Time</h3>
</section>
  <h4 class=\"text-center\"> How have Olympic swimming results changed over time? </h4>
  ')
```
...
```{r,echo=FALSE,message=FALSE}
knitr::asis_output('<iframe height="600" width="100%" frameborder="no" src="https://janthina.shinyapps.io/overall_trend/"> </iframe>')
```

```{r, results='asis', echo=FALSE}
cat('
<section class=\"image-container\">
  <img src=\"menvwomen.png" style=\"width:100%;height:300px;object-fit:cover;\"/>
  <h3 class=\"text-center\">Improvement How?</h3>
</section>
<section id=\"introduction\" class=\"container\" width=\"100%\">
  <h4 class=\"text-center\">Lets dive deeper into these improvements!</h4>
  ')
```
...
```{r, results='asis', echo=FALSE}
cat('
  <h3 class=\"text-center\">Is Swimming Performance Reaching its Peak</h3>
</section>
  <h4 class=\"text-center\"> What are the limits of atheletic performance? </h4>
  ')
```
